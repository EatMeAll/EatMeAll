        ...
        return (
            <React.Fragment>
                ...
                <div className={styles.MealPlan}>
                    <React.Fragment>
                        <DayMealsPlan date={moment().weekday(1)} dayNumber={0} dayPlan={this.props.meals[0]} openModal ={this.showModal} modalClosed={this.cancelHandler}/>
                        <DayMealsPlan date={moment().weekday(2)} dayNumber={1} dayPlan={this.props.meals[1]} openModal ={this.showModal} modalClosed={this.cancelHandler}/>
                        <DayMealsPlan date={moment().weekday(3)} dayNumber={2} dayPlan={this.props.meals[2]} openModal ={this.showModal} modalClosed={this.cancelHandler}/>
                        <DayMealsPlan date={moment().weekday(4)} dayNumber={3} dayPlan={this.props.meals[3]} openModal ={this.showModal} modalClosed={this.cancelHandler}/>
