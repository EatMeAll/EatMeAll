...
public class MealDTOshortFull {
    ...
    public MealDTOshortFull() {
    }

    public MealDTOshortFull(Integer idMeal, Language language, String title, String shortDescription, Boolean isPublic, Set<MealTime> mealTimeSet) {
        this.idMeal = idMeal;
